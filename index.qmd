...
Species richness, especially for benthic macroinvertebrates, is influenced by multiple complex factors when it comes to water quality. But some of the most influential factors seem to be Ph, turbidity, dissolved oxygen, and temperature (citation?).
...
```
According to to the graph above showing total insect count by order in 2013 to 2019, the abundance of insects in the order diptera was the highest in both years, but there was an increse between 2013 and 2019. The abundance of insects in the order Trichoptera, Ephemeroptera, and veneroida, however, decreased from 2013 to 2019.
