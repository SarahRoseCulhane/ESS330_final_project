...
```
The R-squared value of the model built to predict EPT richness is 0.99774293. This is a fairly high value, suggesting high accuracy for our model is fit for the observed data. The root mean squared error and the mean absolute error values are both fairly low, with the rmse value being at 0.1337429 and the mae value being at 0.02964773. These low values suggest that our model is fairly accurate.
```{r}
